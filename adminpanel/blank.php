...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
          ...
          <form method="post">
          	<table>
          		...
          		<tr>
          		 ...
          		 <tr><td>Digree</td>
          		 <td><input type="text" name="digree"></td>
          		 </tr>
          		 <tr><td>Details</td>
	...
	if (empty ( $name ) or empty ( $address ) or   empty ( $phone) or empty ( $email ) or empty ( $about ) or empty ( $facebook ) or empty ( $twitter ) or empty ( $linkedin ) or empty ( $title ) or empty ( $companyname ) or empty ( $date ) )
			{
